...
async function loadLotteryInfo() {
    ...
    try {
        ...
        document.getElementById('jackpot-amount').innerText = `${okbAmount.toLocaleString('zh-CN', { maximumFractionDigits: 4, minimumFractionDigits: 4 })} OKB (￥${(okbAmount * 45.50).toLocaleString('zh-CN', { maximumFractionDigits: 2, minimumFractionDigits: 2 })})`;
